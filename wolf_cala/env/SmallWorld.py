...
class SmallWorld(gym.Env):
    ...
    def reset_true(self):
        path = '/home/fdn/fangdina_wolf_cala/dataset/facebook_combined.txt'
        data = open(path, 'r')
        node_x = []
        node_y = []
        for line in data:
        ...
        #测试时的观点
        self.opinion_gossiper = np.genfromtxt("gossiper_opinions_facebook.csv", delimiter=',', usecols=(1), skip_header=1)
